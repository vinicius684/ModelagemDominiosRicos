...
namespace NerdStore.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeDiferente(string pattern, string valor, string mensagem)//ValdiarExpressao
        {
        ...
        public static void ValidarTamanho(string valor, int maximo, string mensagem)//Validar Caracteres
        {
        ...
        public static void ValidarTamanho(string valor, int minimo, int maximo, string mensagem)//ValidarCaracteres
        {
            var length = valor.Trim().Length;
